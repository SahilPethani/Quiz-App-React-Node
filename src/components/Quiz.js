...
const Quiz = ({ showQuiz, question, subQuizs, checkAnswer, correctAnswer, selectedAnswer, questionIndex, nextQuestion, showTheResult }) => {
            ...
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-8">
                        <div className=" p-4" style={{ background: '#3d3d3d', borderColor: '#646464' , borderRadius:"5px"}}>
                            <div className="d-flex justify-content-between gap-md-3">
                                <h5 className='mb-2 fs-normal lh-base'>{question?.question}</h5>
                                <h5 style={{ color: '#60d600', width: '100px', textAlign: 'right' }}>{subQuizs.indexOf(question) + 1} / {subQuizs?.length}</h5>
                            </div>
                            <div>
                                {
                            ...
                            {
                                (questionIndex + 1) !== subQuizs.length ?
